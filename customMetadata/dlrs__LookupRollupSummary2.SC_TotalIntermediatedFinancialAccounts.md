...
<CustomMetadata xmlns="http://soap.sforce.com/2006/04/metadata" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema">
    <label>SC_TotalIntermediatedFinancialAccounts</label>
    ...
    <values>
        ...
        <value xsi:type="xsd:string">SC_TotalIntermediatedFinancialAccounts__c</value>
    </values>
    <values>
    ...
    <values>
        ...
        <value xsi:type="xsd:string">Declarative lookup roll-up summary field to calculate count of Intermediated Financial Accounts linked to an Account.</value>
    </values>
    <values>
        <field>dlrs__FieldToAggregate__c</field>
        <value xsi:type="xsd:string">SC_ActiveConsultantCount__c</value>
    </values>
    <values>
    ...
    <values>
        ...
        <value xsi:type="xsd:string">SC_ActiveConsultantCount__c &gt; 0</value>
    </values>
    <values>
        <field>dlrs__RelationshipField__c</field>
        <value xsi:type="xsd:string">AW_MasterAccount__c</value>
    </values>
    <values>
